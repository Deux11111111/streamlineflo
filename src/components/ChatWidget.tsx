...
const CHAT_WEBHOOK_URL = "https://hook.eu2.make.com/gonu3z4lcwjujhryw6sh8pns67nylf45"; // your actual webhook URL

const ChatWidget = () => {
  useEffect(() => {
    // Replace the placeholder URL inside the script with your actual webhook URL
    const scriptContent = `/*! Lightweight Chat Popup (vanilla JS, no deps) */
(function () {
  // ====== CONFIG ======
  const WEBHOOK_URL = "${CHAT_WEBHOOK_URL}"; // <-- set this
  const TITLE = "Chat";
