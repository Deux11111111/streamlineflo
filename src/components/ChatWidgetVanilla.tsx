...
export default function CustomN8NChatWidget() {
  useEffect(() => {
    console.log("[CustomN8NChatWidget] useEffect triggered");

    const scriptContent = `(function () {
      console.log("[CustomN8NChatWidget] injected script running");

      // ========= CONFIG =========
      const N8N_WEBHOOK_URL = "https://adrianzap.app.n8n.cloud/webhook/c803253c-f26b-4a80-83a5-53fad70dbdb6"; // Remove /chat from the end
      const TITLE = "Chat";
      ...
      function run() {
        console.log("[CustomN8NChatWidget] run() called");
