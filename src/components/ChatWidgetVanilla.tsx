      ...
      function run() {
        ...
        async function sendMessage(text) {
          ...
          try {
            ...
            else addMessage("assistant", "No 'content' field in response.");
          } catch (err) {
        ...
        input.addEventListener("keydown", (e) => { if (e.key === "Enter" && !e.shiftKey) { e.preventDefault(); if (!sendBtn.disabled) sendMessage(input.value); } });
      }
