...
export default function ChatWidgetVanilla() {
  useEffect(() => {
    ...
    wrap.innerHTML = `
      ...
      <div class="lw-card lw-hidden" id="lw-panel" role="region" aria-live="polite" aria-label="Chat panel">
        ...
        <form class="lw-footer" id="lw-form" autocomplete="off">
          <input class="lw-input" type="text" id="lw-input" placeholder="Type a message" />
          <button class="lw-send" type="submit" id="lw-send" aria-label="Send message">
    ...
    const toggle = shadow.getElementById("lw-toggle");
    ...
    const body = shadow.getElementById("lw-scroll");
